...
def compute_hd95(reference, test, voxel_spacing):
    # based on https://github.com/MIC-DKFZ/nnUNet/blob/nnunetv1/nnunet/evaluation/metrics.py#L332
    ...
    test, reference = test[0], reference[0] # nnunet outputs are 1DHW, medpy expects DHW
    return metric.hd95(test, reference, voxel_spacing, 1)
